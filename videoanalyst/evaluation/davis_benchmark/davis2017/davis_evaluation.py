...
from ..davis2017.davis import DAVIS, alivos1
...
class alivos1valuation(object):
    def __init__(self, davis_root, task, gt_set, sequences='all', codalab=False,version = '2017'):
        ...
        self.davis_root = davis_root
        self.task = task
        self.dataset = alivos1(root=davis_root, task=task, subset=gt_set, sequences=sequences, codalab=codalab,version = version)
