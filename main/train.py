...
def make_parser():
    ...
    parser.add_argument('-cfg',
                        '--config',
                       # default='/home/jaffe/PycharmProjects/state aware VOS/experiments/sat/train/sat_res50_train_alivos1.yaml',
                       # default='/home/jaffe/PycharmProjects/stateawareVOS/experiments/sat/train/sat_res50_davis17.yaml',
                        default='/home/jaffe/PycharmProjects/stateawareVOS/experiments/siamfcpp/train/got10k/siamfcpp_alexnet-trn.yaml',
                        type=str,
                        help='path to experiment configuration')
    parser.add_argument(
        '-r',
        '--resume',
       # default="/home/jaffe/PycharmProjects/stateawareVOS/snapshots/sat_res50_alivos1/epoch-0.pkl",
