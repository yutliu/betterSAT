...
def make_parser():
    ...
    parser.add_argument('-cfg',
                        '--config',
                        default = 'experiments/sat/train/sat_res50_train_alivos1.yaml',
                       # default='/data2/jaffeProj/stateawareVOS/experiments/sat/train/sat_res50_train_alivos1.yaml',
                        type=str,
                        help='path to experiment configuration')
    parser.add_argument(
        '-r',
        '--resume',
        default='models/mytrain/threedatas_20epoch.pkl',
...
if __name__ == '__main__':
    # parsing
   # a = torch.load('/home/jaffe/PycharmProjects/stateawareVOS/snapshots/sat_res50_alivos1/epoch-0.pkl')

  #  encoder_basemodel_pkl = torch.load('/home/jaffe/PycharmProjects/stateawareVOS/./models/resnet/res-50-imagenet-fff49.pkl')
   # gml_extractor_pkl = torch.load('/home/jaffe/PycharmProjects/stateawareVOS/./models/resnet/res-50-imagenet-fff49.pkl')
